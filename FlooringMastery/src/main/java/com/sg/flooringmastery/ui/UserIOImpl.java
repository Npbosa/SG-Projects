...
public class UserIOImpl implements UserIO {
        ...
        /*
             * A very simple method that takes in a message to display on the
             * console and then waits for a integer answer from the user to
             * return.
             *
         ...
         *
         * @param msgPrompt - String explaining what information you want from
         * the user.
        ...
        /**
         *
         * A slightly more complex method that takes in a message to display on
         * the console, and then waits for a integer answer within the specified
         * min/max range and returns it.
         *
         * @param msgPrompt - String explaining what information you want from
         * the user.
         * @param min - minimum acceptable value for return
         * @param max - maximum acceptable value for return
         * @return an integer value as an answer to the message prompt within
         * the min/max range
         */
        @Override
        ...
        /**
         * A slightly more complex method that takes in a message to display on
         * the console, and then waits for a long answer within the specified
         * min/max range and returns it.
         *
         * @param msgPrompt - String explaining what information you want from
         * the user.
         ...
         *
         * A slightly more complex method that takes in a message to display on
         * the console, and then waits for a float answer within the specified
         * min/max range and returns it.
         *
         * @param msgPrompt - String explaining what information you want from
         * the user.
         ...
         *
         * A slightly more complex method that takes in a message to display on
         * the console, and then waits for a double answer within the specified
         * min/max range and returns it.
         *
         * @param msgPrompt - String explaining what information you want from
         * the user.
