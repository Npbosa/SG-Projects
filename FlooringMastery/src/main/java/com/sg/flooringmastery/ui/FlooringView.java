...
public class FlooringView {
    ...
    public String showPromptAndGetDate() {
    ...
    public void listMenu(List<Order> orders) {
    ...
    public Order getNewOrderInfo(String orderNum) {
        io.print("* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *");
        io.print("******** Add Order ********");
//        BigDecimal oldOrderNumber = new BigDecimal(orderNum).add(BigDecimal.ONE);
        String finalOrderNumber = "5000";//oldOrderNumber.toString().trim();
    ...
    public String getOrderToBeRemoved(){
