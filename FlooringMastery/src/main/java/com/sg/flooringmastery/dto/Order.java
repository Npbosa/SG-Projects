...
public class Order {
    ...
    private String orderNumber;//given in controller
    private String customerName;//given in controller
    private String state;//given in controller
    private BigDecimal taxRate;//get this from taxDao***------
    private String productType;//given in controller
    private BigDecimal area;//given in controller
    private BigDecimal costPerSquareFoot;//ProductsDao***------
    private BigDecimal laborCostPerSquareFoot;//ProductsDao***------
    private BigDecimal materialCost;//service layer
    private BigDecimal laborCost;//service layer**!
    private BigDecimal tax;//service layer**!
    private BigDecimal total;//service layer**!
    private String date;
